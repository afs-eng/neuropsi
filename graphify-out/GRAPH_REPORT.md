...
## Summary
- 7001 nodes · 12633 edges · 212 communities detected
- Extraction: 73% EXTRACTED · 27% INFERRED · 0% AMBIGUOUS · INFERRED: 3390 edges (avg confidence: 0.73)
...
1. `GET()` - 702 edges
2. `_build_context()` - 97 edges
3. `split()` - 92 edges
4. `_build_adolescent_document()` - 88 edges
5. `_rebuild_qualitative_section()` - 74 edges
6. `testContext()` - 63 edges
7. `ReportExportChartSanitizationTests` - 61 edges
8. `TestContext` - 49 edges
9. `find()` - 47 edges
...
Cohesion: 0.01
Nodes (310): gerar_grafico_bpa(), gerar_grafico_bpa_bytes(), _render_bpa_chart(), calculate_factor_score(), calculate_raw_scores(), classificar_percentil(), classify_bfp_domain(), classify_guilmette() (+302 more)

### Community 1 - "Community 1"
Cohesion: 0.02
Nodes (266): getUserInitials(), getDisplayName(), getUserInitials(), split(), build_clinical_summary(), Pt(), formatClassification(), handleExportDocx() (+258 more)

### Community 2 - "Community 2"
Cohesion: 0.02
Nodes (180): get_instrument_age_rule(), create_test_application(), update_test_application(), BaseModel, BaseTestModule, calcular_escore(), calcular_pontuacoes(), calculate_total() (+172 more)

### Community 3 - "Community 3"
Cohesion: 0.02
Nodes (196): convert_a1_to_csv(), convert_composite_scores(), convert_psychometrics(), convert_supplementary(), expand_range_to_raw_scores(), main(), parse_range(), Conversor de tabelas XLSM/XLSX do WAIS-III para CSV.  Converte as tabelas normat (+188 more)

### Community 4 - "Community 4"
Cohesion: 0.02
Nodes (151): check(), ensure_available(), _timeout(), AILogService, log_generation_end(), log_generation_error(), log_generation_start(), build_anamnesis_snapshot() (+143 more)

### Community 5 - "Community 5"
Cohesion: 0.02
Nodes (169): Migration, seed_templates_v2(), AbstractUser, UserAdmin, BearerAuth, BaseUserAdmin, get_default_templates(), create_admin() (+161 more)
...
Cohesion: 0.03
Nodes (156): e(), build_js(), main(), merge(), Merge user data over defaults recursively for top-level keys., Retorna o código Node.js completo que gera o .docx., $(), A() (+148 more)
...
Cohesion: 0.03
Nodes (126): affectedCheckboxes(), checker(), clearAcross(), hide(), ready(), reset(), show(), showClear() (+118 more)

### Community 13 - "Community 13"
Cohesion: 0.07
Nodes (82): _class(), _education_label(), _normative_label(), _num(), _build_user_prompt(), generate_for_application(), _parse_json_response(), _provider_configured() (+74 more)
...
Cohesion: 0.04
Nodes (75): EvaluationAdmin, EvaluationDocumentAdmin, PatientAdmin, AIHealthcheckService, Patient, ReportStub, can_access_patient(), can_edit_patients() (+67 more)

### Community 16 - "Community 16"
Cohesion: 0.05
Nodes (94): Meta, Status, TestApplication, TestApplicationQuerySet, ai_health(), Preview WAIS-III results without saving to database.          This endpoint is u, Preview WAIS-III results without saving to database.          This endpoint is u, Preview WAIS-III results without saving to database.          This endpoint is u (+86 more)
...
Cohesion: 0.06
Nodes (62): _b7_column_indexes(), _b8_column_name(), build_process_scores(), buscar_ponderado(), _calcular_idade(), calculate_confidence_interval(), calculate_index_score(), calculate_qi_total() (+54 more)
...
Cohesion: 0.06
Nodes (37): _build_chart_series_item(), build_fdt_charts(), _build_scale_result(), calculate_derived_scores(), calculate_error_result(), calculate_fdt_results(), calculate_metric_result(), calculate_stage_totals() (+29 more)
...
Cohesion: 0.15
Nodes (10): build_computed_payload(), calculate_raw_total(), convert_raw_to_norms(), get_highest_domains(), is_failure(), load_cars2_hf_norms(), load_scoring_rules(), normalize_answer() (+2 more)
...
- **Thin community `Community 84`** (12 nodes): `page.tsx`, `page.tsx`, `page.tsx`, `page.tsx`, `page.tsx`, `page.tsx`, `page.tsx`, `page.tsx`, `page.tsx`, `page.tsx`, `page.tsx`, `TestEditPage()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 87`** (10 nodes): `Migration`, `seed_templates()`, `0001_initial.py`, `0001_initial.py`, `0001_initial.py`, `0001_initial.py`, `0001_initial.py`, `0001_initial.py`, `0001_initial.py`, `0001_initial.py`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 98`** (7 nodes): `env_bool()`, `env_list()`, `Base Django settings shared across environments.`, `base.py`, `production.py`, `_append_unique()`, `_hostname_from_url()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 99`** (6 nodes): `__init__.py`, `AIGuard`, `check_output_length()`, `sanitize_output()`, `validate_data_safety()`, `validate_no_clinical_decision()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 106`** (4 nodes): `add_wais3_instrument()`, `Migration`, `remove_wais3_instrument()`, `0003_add_wais3_instrument.py`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 108`** (4 nodes): `deactivate_v1_templates()`, `Migration`, `reactivate_v1_templates()`, `0003_deactivate_v1_templates.py`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 111`** (4 nodes): `InternalAnamnesisEditor.tsx`, `saveDraft()`, `submitResponse()`, `updateField()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 112`** (3 nodes): `manage.py`, `main()`, `Run administrative tasks.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 114`** (3 nodes): `Migration`, `populate_status()`, `0004_testapplication_status.py`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 115`** (3 nodes): `Migration`, `seed_default_instruments()`, `0002_seed_default_instruments.py`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 116`** (3 nodes): `convert_one()`, `main()`, `convert_csvs_to_xlsm.py`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 117`** (3 nodes): `Calendar()`, `calendar.js`, `calendar.js`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 118`** (3 nodes): `nav_sidebar.js`, `initSidebarQuickFilter()`, `nav_sidebar.js`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 119`** (3 nodes): `e()`, `cs.js`, `cs.js`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 120`** (3 nodes): `sr-Cyrl.js`, `n()`, `sr-Cyrl.js`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 121`** (3 nodes): `ru.js`, `n()`, `ru.js`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 122`** (3 nodes): `uk.js`, `uk.js`, `n()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 123`** (3 nodes): `lt.js`, `n()`, `lt.js`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 124`** (3 nodes): `hr.js`, `n()`, `hr.js`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 125`** (3 nodes): `sr.js`, `n()`, `sr.js`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 128`** (3 nodes): `page.tsx`, `page.tsx`, `Page()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 132`** (3 nodes): `README.md`, `Normas do BAI`, `README.md`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 134`** (2 nodes): `Migration`, `0011_patient_created_by.py`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 135`** (2 nodes): `Migration`, `0002_patient_grade_year_patient_institution.py`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 136`** (2 nodes): `Migration`, `0009_alter_patient_notes_null.py`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 137`** (2 nodes): `Migration`, `0003_alter_patient_schooling.py`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 138`** (2 nodes): `Migration`, `0008_patient_responsible_name_patient_responsible_phone.py`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 139`** (2 nodes): `Migration`, `0006_alter_patient_occupation.py`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 140`** (2 nodes): `Migration`, `0010_alter_patient_responsible_null.py`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 141`** (2 nodes): `Migration`, `0004_alter_patient_schooling.py`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 142`** (2 nodes): `Migration`, `0005_remove_patient_institution.py`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 143`** (2 nodes): `Migration`, `0007_remove_patient_occupation.py`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 146`** (2 nodes): `Migration`, `0002_evaluationprogressentry.py`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 149`** (2 nodes): `Migration`, `0004_report_ai_metadata_reportsection_generation_metadata_and_more.py`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 150`** (2 nodes): `Migration`, `0002_alter_reportsection_options_and_more.py`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 151`** (2 nodes): `Migration`, `0003_report_interested_party_report_purpose.py`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 154`** (2 nodes): `Migration`, `0007_user_two_factor_fields.py`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 155`** (2 nodes): `Migration`, `0003_alter_user_crp_alter_user_email.py`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 156`** (2 nodes): `Migration`, `0005_user_sex.py`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 157`** (2 nodes): `Migration`, `0004_alter_user_crp_alter_user_email.py`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 158`** (2 nodes): `wsgi.py`, `WSGI config for config project.  It exposes the WSGI callable as a module-level`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 159`** (2 nodes): `ASGI config for config project.  It exposes the ASGI callable as a module-level`, `asgi.py`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 219`** (1 nodes): `Classifica o escore bruto do BAI conforme faixas normativas.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 220`** (1 nodes): `Classifica o escore T do BAI conforme faixas normativas.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 239`** (1 nodes): `Verifica se a avaliação possui dados mínimos para gerar um laudo clínico coerent`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 240`** (1 nodes): `Regenera o texto de uma única seção baseando-se no snapshot de contexto original`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 241`** (1 nodes): `Atualiza o conteúdo editado pelo profissional`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 412`** (1 nodes): `Run administrative tasks.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 413`** (1 nodes): `Procura na tabela normativa o T-Score e Percentil exatos para o Ponto Bruto.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 414`** (1 nodes): `Case reproduzindo os dados do WAIS-III 2020 para um adulto de 30 anos.      Os v`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 415`** (1 nodes): `Carrega Tabela B.1: valores críticos para discrepâncias entre índices.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 416`** (1 nodes): `Carrega Tabela B.3: diferenças entre subteste e média.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 417`** (1 nodes): `Carrega Tabela B.6: Dígitos Ordem Direta e Inversa.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 418`** (1 nodes): `Converte string '2,4' → 2.4 ou None.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 419`** (1 nodes): `Mapeia 'idade_30-39' → chave B.1 '30-39'.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 420`** (1 nodes): `Mapeia faixa etaria para coluna B.6: retorna índice da coluna.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 421`** (1 nodes): `Executa análises complementares B.1, B.3, B.6, B.7.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 422`** (1 nodes): `Return the computed payload augmented with GAI and clusters using WAIS-III table`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 423`** (1 nodes): `Load GAI table from CSV.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 424`** (1 nodes): `Load cluster table from CSV.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 425`** (1 nodes): `Calculate clinical clusters C.2 to C.9.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 426`** (1 nodes): `Classify Wechsler scale score.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 427`** (1 nodes): `Estimativa de fallback do QIT quando a soma está fora do range da tabela.     A`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 428`** (1 nodes): `Converte ponto ponderado (1-19) em percentil usando tabela normativa do WISC-IV.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 429`** (1 nodes): `IC para escore ponderado de subteste (IC 95% por padrão).`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 430`** (1 nodes): `Lookup composite score, percentile, and confidence intervals from equivalence ta`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 431`** (1 nodes): `Lookup GAI (General Ability Index) from Tabela-GAI.csv.     Returns: {'escore':`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 432`** (1 nodes): `Lookup CPI (Cognitive Proficiency Index) from Tabela-CPI.csv.     Returns: {'esc`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 433`** (1 nodes): `Preview WAIS-III results without saving to database.          This endpoint is u`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 434`** (1 nodes): `Valida raw_scores do contexto.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 435`** (1 nodes): `Calcula escores do BAI a partir do TestContext.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 436`** (1 nodes): `Classifica resultados do BAI.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 437`** (1 nodes): `Gera interpretação do BAI.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 438`** (1 nodes): `Gera o gráfico WASI e salva em arquivo.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 439`** (1 nodes): `Regenera o texto de uma única seção baseando-se no snapshot de contexto original`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 440`** (1 nodes): `Atualiza o conteúdo editado pelo profissional`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 441`** (1 nodes): `ASGI config for config project.  It exposes the ASGI callable as a module-level`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 442`** (1 nodes): `WSGI config for config project.  It exposes the WSGI callable as a module-level`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 443`** (1 nodes): `Base Django settings shared across environments.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 458`** (1 nodes): `Case reproduzindo os dados do WAIS-III 2020 para um adulto de 30 anos.      Os v`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 459`** (1 nodes): `Preview WAIS-III results without saving to database.          This endpoint is u`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 460`** (1 nodes): `Load cluster table from CSV.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 461`** (1 nodes): `Calculate clinical clusters C.2 to C.9.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 462`** (1 nodes): `Classify Wechsler scale score.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 463`** (1 nodes): `Return the computed payload augmented with GAI and clusters using WAIS-III table`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 464`** (1 nodes): `Load GAI table from CSV.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 465`** (1 nodes): `Load cluster table from CSV.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 466`** (1 nodes): `Calculate clinical clusters C.2 to C.9.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 467`** (1 nodes): `Classify Wechsler scale score.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 468`** (1 nodes): `Load GAI table from CSV.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 469`** (1 nodes): `Load cluster table from CSV.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 470`** (1 nodes): `Calculate clinical clusters C.2 to C.9.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 471`** (1 nodes): `Classify Wechsler scale score.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 472`** (1 nodes): `Estimate CPI from sum of scaled scores.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 473`** (1 nodes): `Preview WAIS-III results without saving to database.          This endpoint is u`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 474`** (1 nodes): `Estimativa de fallback do QIT quando a soma está fora do range da tabela.     A`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 475`** (1 nodes): `Converte ponto ponderado (1-19) em percentil usando tabela normativa do WISC-IV.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 476`** (1 nodes): `IC para escore ponderado de subteste (IC 95% por padrão).`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 477`** (1 nodes): `Lookup composite score, percentile, and confidence intervals from equivalence ta`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 478`** (1 nodes): `Lookup GAI (General Ability Index) from Tabela-GAI.csv.     Returns: {'escore':`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 479`** (1 nodes): `Lookup CPI (Cognitive Proficiency Index) from Tabela-CPI.csv.     Returns: {'esc`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Thin community `Community 487`** (1 nodes): `Preview WAIS-III results without saving to database.          This endpoint is u`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 488`** (1 nodes): `Preview WAIS-III results without saving to database.          This endpoint is u`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Why does `GET()` connect `Community 0` to `Community 1`, `Community 2`, `Community 3`, `Community 4`, `Community 5`, `Community 10`, `Community 12`, `Community 13`, `Community 14`, `Community 15`, `Community 18`, `Community 23`, `Community 26`, `Community 32`, `Community 38`, `Community 39`, `Community 64`, `Community 83`, `Community 89`?**
  _High betweenness centrality (0.151) - this node is a cross-community bridge._
- **Why does `SKILL — Geração de PDF Padrão Ouro via HTML + Playwright` connect `Community 25` to `Community 12`?**
  _High betweenness centrality (0.019) - this node is a cross-community bridge._
- **Why does `Footer padrão obrigatório` connect `Community 12` to `Community 25`?**
  _High betweenness centrality (0.018) - this node is a cross-community bridge._
- **Are the 698 inferred relationships involving `GET()` (e.g. with `log()` and `_get_client_ip()`) actually correct?**
  _`GET()` has 698 INFERRED edges - model-reasoned connections that need verification._
- **Are the 213 inferred relationships involving `str` (e.g. with `_send_via_evolution()` and `.test_all_ncp_tables_include_supplemental_columns()`) actually correct?**
  _`str` has 213 INFERRED edges - model-reasoned connections that need verification._
- **Are the 15 inferred relationships involving `_build_context()` (e.g. with `.test_build_context_uses_bpa2_pdf_layout_data()` and `.test_build_context_uses_wisc4_pdf_layout_data()`) actually correct?**
  _`_build_context()` has 15 INFERRED edges - model-reasoned connections that need verification._
- **Are the 91 inferred relationships involving `split()` (e.g. with `_get_client_ip()` and `serialize_document()`) actually correct?**
  _`split()` has 91 INFERRED edges - model-reasoned connections that need verification._